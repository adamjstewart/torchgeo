...
class VHR10(NonGeoDataset):
    ...
    * https://doi.org/10.3390/rs12060989
    ...
    target_meta = {
        'url': 'https://raw.githubusercontent.com/chaozhong2010/VHR-10_dataset_coco/ce0ba0f5f6a0737031f1cbe05e785ddd5ef05bd7/NWPU%20VHR-10_dataset_coco/annotations.json',
