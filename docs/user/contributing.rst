...
In this example, we see a 60% speed-up for RandomSpatialSampler on preprocessed data. All other numbers are more or less the same across multiple runs.
